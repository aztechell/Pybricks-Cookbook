...
Этот код вычисляет примерный процент заряда, основываясь на диапазоне напряжения от 6.0В (разряжен) до 8.4В (полностью заряжен).
...
На графике ниже показано, как напряжение литий-ионного аккумулятора падает по мере разряда. Обратите внимание, что падение не линейно.

![График разряда](img/img_1.png){width = 150}
